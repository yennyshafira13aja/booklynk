    ...
    <div class="max-w-7xl mx-auto px-6">
        <div class="flex justify-between h-16 items-center">
            ...
            <div class="flex gap-6 text-sm font-medium items-center">
                ...
                <!-- ✅ MENU PETUGAS (LEBIH SEDIKIT) -->
                <a href="{{ route('petugas.dashboard') }}"
                   class="{{ request()->routeIs('petugas.dashboard')
                        ? 'text-blue-600 font-semibold border-b-2 border-blue-600'
                        : 'text-gray-700 hover:text-blue-600' }}">
                    Dashboard
                </a>

                <a href="{{ route('petugas.peminjam.index') }}"
                class="{{ request()->routeIs('petugas.peminjam.*')
                        ? 'text-blue-600 font-semibold border-b-2 border-blue-600'
                        : 'text-gray-700 hover:text-blue-600' }}">
                    Data Peminjam
                </a>
                ...
                class="{{ request()->routeIs('petugas.buku.*')
                        ? 'text-blue-600 font-semibold border-b-2 border-blue-600'
                        : 'text-gray-700 hover:text-blue-600' }}">
                    Data Buku
                </a>
                ...
                class="{{ request()->routeIs('petugas.kategori.*')
                        ? 'text-blue-600 font-semibold border-b-2 border-blue-600'
                        : 'text-gray-700 hover:text-blue-600' }}">
                    Data Kategori
                </a>
                ...
                class="{{ request()->routeIs('petugas.laporan.*')
                        ? 'text-blue-600 font-semibold border-b-2 border-blue-600'
                        : 'text-gray-700 hover:text-blue-600' }}">
                    Laporan
                </a>
